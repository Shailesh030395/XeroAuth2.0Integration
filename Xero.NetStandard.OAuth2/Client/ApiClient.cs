...
namespace Xero.NetStandard.OAuth2.Client
{
    ...
    internal class CustomJsonCodec : RestSharp.Serializers.ISerializer, RestSharp.Deserializers.IDeserializer
    {
        ...
        internal object Deserialize(IRestResponse response, Type type)
        {
            ...
            {
                throw new ApiException(500, response.Content);
            }
        }
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiResponse<T> Execute<T>(RestRequest req, IReadableConfiguration configuration) where T : new()
        {
        ...
        private async Task<ApiResponse<T>> Exec<T>(RestRequest req, IReadableConfiguration configuration)
        {
            ...
            var objResponse = client.ExecuteTaskAsync<T>(req);
            var response = objResponse.Result;
        ...
        public async Task<ApiResponse<T>> GetAsync<T>(string path, RequestOptions options, IReadableConfiguration configuration = null)
        {
            ...
            //var response = Exec<T>(newRequest(HttpMethod.Get, path, options, config), config);
